...
export const BorderLoadingIndicator = ({
    ...
    return (
        <>
            <div className={cn("absolute -top-[2px] -left-[2xp] h-[calc(100%+4px)] w-[calc(100%+4px)]", className)}>
                <style>
                    {`
        @keyframes spin {
        ...
        `}
                ...
                <div className={cn("absolute inset-0 overflow-hidden rounded-sm", className)}>
                    <div className={cn("spinner rounded-full bg-[conic-gradient(from_0deg_at_50%_50%,rgba(42,67,233,0.5)_0deg,rgba(42,138,246,0)_360deg)]", className)} />
                </div>
            </div>
            {children}
        </>
...
const StatusBorder = ({
    ...
    return (
        <>
            <div
                className={cn(
                    "absolute -top-[2px] -left-[2px] h-[calc(100%+4px)] w-[calc(100%+4px)] rounded-sm border-3",
                    className,
                )}
            />
            {children}
